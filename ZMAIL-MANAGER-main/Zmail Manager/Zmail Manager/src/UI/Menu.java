        ...
        while(menuIsActive){ //Variable que controla el menu
            ...
            switch (mailScanner){// Variable que controla el menu inicio de sesion
                case 1:
                        ...
                        while (userLogued){
                            ...
                            switch (userLoguedOption){
                                case 1:
                                    ...
                                    while(inMenu){// Variable que controla el menu de los usuarios una vez en sesion
                                        ...
                                        switch (contactListOption){// Variable que controla el menu de mensajes de usario pro
                                            case 1:
                                                ...
                                                if(!fileMailExists){//Se muestra cuando el archivo no esta creado
                                            ...
                                            case 2:// Envia un mail a un solo receptor
                                                ...
                                                if(!uM_G.validateUserExists(uMZR)){// Valida que el usuario exista
                                                ...
                                                if(!fileMailExists && validator){//Se muestra cuando el archivo no esta creado
                                                    System.out.println("\u001B[34m¡Felicidades! Eres el primer usuario en enviar un Mail\u001B[0m");
                                                    System.out.println("\u001B[34mEl programa se cerrará para actualizar de forma correcta los datos.\u001B[0m");
                                                    System.out.println("\u001B[34mAl finalizar, puedes volver a entrar. Este mensaje no volverá a aparecer.\u001B[0m");
                                                    JSONUtiles.uploadToFile(new JSONArray(),"Mails.json");
                                    ...
                                    break;
                                case 2:// Obtiene los correos recibidos de un usuario
                                    ...
                                    break;
                                case 3:// Obtiene los correos enviados de un usuario
                                        ...
                                        break;
                                case 4:// Agrega o elimina contactos de la lista de contactos de un usuario pro
                                        ...
                                        do {
                                            ...
                                            do {
                                                try {
                                                    ...
                                                    scanner.nextLine();
                                                    inputValid = addDeleteUsers >= 1 && addDeleteUsers <= 2;
                                                    if (!inputValid) {
                                    ...
                                    }else{// Vuelve al menu anterior cuando el usuario no es pro
                                    ...
                                    break;
                                case 5://Vuelve al menu anterior cuando el usuario pro ingresa el numero 5
                                    if(UsersManager.isUserPro(zmail)){
                                        System.out.println("Volviendo...");
                                        userLogued=false;
                                        break;
                    ...
                    break;
                case 2://Menu para registrar el tipo de cuenta
                    ...
                    while(menuAccountType){
                        ...
                        switch (registerOption) {
                            case 1:// Registra un usuario estandar
                                ...
                                if(uMPerson.registerUser(personUser)){
                                    if(!fileExists){//Se muestra cuando el archivo no esta creado
                                ...
                                break;
                            case 2://Registra una cuenta usuario business
                                String companyName = "";
                                ...
                                break;
                            case 3://Registra un usuario business pro
                                String companyName1 = "";
